...
{
    [Required, StringLength(100)] public string Origin { get; set; }
    [Required, StringLength(100)] public string Destination { get; set; }
    [Required, DataType(DataType.Date), DisplayName("Departure Date")] public DateTime DepartDate { get; set; }
    [DataType(DataType.Date), DisplayName("Return Date")] public DateTime? ReturnDate { get; set; }
    [Range(1, 10)] public int Passengers { get; set; } = 1;
...
public class BookTripVM
{
    ...
    [Required, Range(1, 10)] public int NumberOfSeats { get; set; } = 1;
...
public class PassengerVM
{
    ...
    [Required(ErrorMessage = "Passenger name is required.")] public string Name { get; set; }
    [Range(1, 100, ErrorMessage = "Age must be between 1 and 100.")] public int Age { get; set; }
...
{
    public string TripId { get; set; }
    [ValidateNever] public Trip? Trip { get; set; }
...
public class AdminVM
{
    ...
    [Required, StringLength(11), RegularExpression(@"^[0-9+\-\s]*$")] public string Phone { get; set; }
    [DataType(DataType.Password)] public string? Password { get; set; }
    [Compare("Password"), DataType(DataType.Password), DisplayName("Confirm Password")] public string? ConfirmPassword { get; set; }
    public IFormFile? Photo { get; set; }
...
public class DriverVM
{
    ...
    [Required, MaxLength(20), Display(Name = "License Number")] public string LicenseNumber { get; set; }
    [DataType(DataType.Password)] public string? Password { get; set; }
